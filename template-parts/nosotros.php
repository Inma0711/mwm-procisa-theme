<section id="nosotros">
          <div class="container">
            ...
            <div class="icon-works">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-about.png" alt="nosotros">
            </div>
            <p class="text-center lead">
            <?php 
            if (function_exists('get_field')) {
                echo wp_kses_post(get_field('nosotros_texto'));
            } else {
                echo 'Nuestro equipo humano integra e incorpora la experiencia y conocimiento 
                adquiridos durante 44 años por la compañía con las últimas innovaciones. 
                Este conjunto de habilidades nos permite generar soluciones especificas 
                para cada sector.';
            }
            ?>
            </p>
